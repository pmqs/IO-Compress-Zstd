package IO::Uncompress::UnZstd ;

use strict ;
use warnings;
use bytes;

use IO::Compress::Base::Common  2.205 qw(:Status createSelfTiedObject);

use IO::Uncompress::Base  2.205 ;
use IO::Uncompress::Adapter::UnZstd  2.205 ;
...
@EXPORT_OK = qw( $UnZstdError unzstd ) ;
...
{
    my $class = shift ;
    my $obj = createSelfTiedObject($class, \$UnZstdError);
...
sub unzstd
{
    my $obj = createSelfTiedObject(undef, \$UnZstdError);
    return $obj->_inf(@_);
}
...
For writing zstd files/buffers, see the companion module IO::Compress::Zstd.

=head1 Functional Interface

A top-level function, C<unzstd>, is provided to carry out
...
section.
    ...
    unzstd $input_filename_or_reference => $output_filename_or_reference [,OPTS]
        or die "unzstd failed: $UnZstdError\n";

The functional interface needs Perl5.005 or better.

=head2 unzstd $input_filename_or_reference => $output_filename_or_reference [, OPTS]

C<unzstd> expects at least two parameters,
...
characters "<" and ">" C<unzstd> will assume that it is an
...
The optional parameters for the one-shot function C<unzstd>
...
C<unzstd> that are filehandles.

If C<AutoClose> is specified, and the value is true, it will result in all
input and/or output filehandles being closed once C<unzstd> has
completed.
...
To uncompress all files in the directory "/my/home" that match "*.txt.zst" and store the compressed data in the same directory

    use strict ;
    use warnings ;
    use IO::Uncompress::UnZstd qw(unzstd $UnZstdError) ;

    unzstd '</my/home/*.txt.zst>' => '</my/home/#1.txt>'
        or die "unzstd failed: $UnZstdError\n";
...
and if you want to compress each file one at a time, this will do the trick
    ...
    for my $input ( glob "/my/home/*.txt.zst" )
    {
        my $output = $input;
        $output =~ s/.zst// ;
        unzstd $input => $output
            or die "Error compressing '$input': $UnZstdError\n";
    }
...
IO::Uncompress::UnZstd can be used exactly like an L<IO::File|IO::File> filehandle.
...
either the C<close> method is called or the IO::Uncompress::UnZstd object is
destroyed.
...
When reading the compressed input data, IO::Uncompress::UnZstd will read it in
...
the IO::Uncompress::UnZstd object is destroyed (either explicitly or by the
...
If the C<AutoClose> option has been enabled when the IO::Uncompress::UnZstd
...
Imports C<unzstd> and C<$UnZstdError>.
Same as doing this
...
L<Compress::Zlib>, L<IO::Compress::Gzip>, L<IO::Uncompress::Gunzip>, L<IO::Compress::Deflate>, L<IO::Uncompress::Inflate>, L<IO::Compress::RawDeflate>, L<IO::Uncompress::RawInflate>, L<IO::Compress::Bzip2>, L<IO::Uncompress::Bunzip2>, L<IO::Compress::Lzma>, L<IO::Uncompress::UnLzma>, L<IO::Compress::Xz>, L<IO::Uncompress::UnXz>, L<IO::Compress::Lzip>, L<IO::Uncompress::UnLzip>, L<IO::Compress::Lzop>, L<IO::Uncompress::UnLzop>, L<IO::Compress::Lzf>, L<IO::Uncompress::UnLzf>, L<IO::Compress::Zstd>, L<IO::Uncompress::AnyInflate>, L<IO::Uncompress::AnyUncompress>
